...
<%
    ...
    if ("ok".equals(request.getParameter("build"))) {
        userlist = biz.getUserByBuilding(Integer.parseInt(request.getParameter("building")));
    }
    else userlist=biz.listUser();
%>
<!DOCTYPE HTML>
<html>
<head>
            ...
            <div class="content">
                <div class="women_main">
                    ...
                    <div class="middle-content">
                        ...
                        <div>
                            <form action="lookuser.jsp?build=ok" method="post" id="searchbybuild">
                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><a href="updateuser.jsp?id=<%=user.getId()%>">修改</a> </td>
