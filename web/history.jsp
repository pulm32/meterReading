...
<%@ page import="meterReading.biz.UserBiz" %>
...
<%
    ...
    UserInfo userInfo=userBiz.getUserById(id);
    MeterBiz meterBiz=new MeterBiz();
    List<MeterLog> list1=meterBiz.getMeterByUserId(id,1);
    List<MeterLog> list2=meterBiz.getMeterByUserId(id,2);
    List<MeterLog> list3=meterBiz.getMeterByUserId(id,3);
%>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <%
                                        for (int i = 0; i < list1.size(); i++) {
                                            MeterLog meterLog1=(MeterLog) list1.get(i);
                                    %>
                                    <tr>
                                        <td><%=meterLog1.getDate()%></td>
                                        <td><%=meterLog1.getDisplay()%></td>
                                    </tr>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <%
                                        for (int i = 0; i < list2.size(); i++) {
                                            MeterLog meterLog2=(MeterLog) list2.get(i);
                                    %>
                                    <tr>
                                        <td><%=meterLog2.getDate()%></td>
                                        <td><%=meterLog2.getDisplay()%></td>
                                    </tr>
                                    <%
                                        }
                                    %>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <%
                                        for (int i = 0; i < list3.size(); i++) {
                                            MeterLog meterLog3=(MeterLog) list3.get(i);
                                    %>
                                    <tr>
                                        <td><%=meterLog3.getDate()%></td>
                                        <td><%=meterLog3.getDisplay()%></td>
                                    </tr>
                                    <%
                                        }
                                    %>
