...
<script language="javascript">
    function firm() {
        if (confirm("添加成功")) {
            location.href = "http://localhost:8080/adduser.jsp";
        } else {
            alert("取消");
        }
    }
...
<%
    ...
    if ("ok".equals(request.getParameter("add"))){
        UserInfo info=new UserInfo();
        info.setName(request.getParameter("name"));
        info.setDoor(request.getParameter("door"));
        info.setMobilephone(request.getParameter("mobilephone"));
        info.setBuilding(Integer.parseInt(request.getParameter("building")));
        info.setPhone(request.getParameter("phone"));
        info.setPermanent(request.getParameter("permanent"));
        info.setWorkunit(request.getParameter("workunit"));
        //info.setValid(Integer.valueOf(request.getParameter("valid")));
        biz.insert(info);
        //out.println("<script> firm();</script>");
    }
%>
            ...
            <div class="content">
                <div class="women_main">
                    ...
                    <div class="middle-content">
                        <div>
                            <h3>大家都在搜：</h3>
                            <form action="adduser.jsp?add=ok" method="post" id="add">
                                ...
                                <tr>
                                    <td>是否常住：</td>
                                    <td> <select name="permanent"><option value="Y">是</option>
                                ...
                                <tr>
                                    <div class="item"><button type="submit">添加</button></div>
                                </tr>
                            </form>
                        </div>
                        ...
                        <div id="owl-demo" class="owl-carousel text-center">
                            ...
                            <div class="item"><a href="bookdetail.jsp?id=<%//=book.getId()%>">
                                <img class="lazyOwl img-responsive"
                                     data-src="lib/images/BookCovers/<%//=book.getISBN()%>.jpg"
                                     alt="<%//=book.getTitle()%>">
                            </a>
                            </div>
                            <%
    ...
    <div class="sidebar-menu">
        ...
        <div class="menu">
            <ul id="menu">
                ...
                <li><a href="lookmeter.jsp"><i class="fa fa-inbox"></i> <span>查看表</span></a></li>
