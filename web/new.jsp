...
<%
  ...
  UserInfo userInfo=userBiz.getuserByBuildingandDoor(Integer.parseInt(building),door);
...
<script language="javascript">
  ...
  function DisplayHot() {
    ...
    var name2 = XMLHttpReq.responseXML.getElementsByTagName("na2")[0].firstChild.nodeValue;
    var count2 = XMLHttpReq.responseXML.getElementsByTagName("co2")[0].firstChild.nodeValue;
    ...
    document.getElementById("product2").innerHTML = name2;
    document.getElementById("co2").innerHTML = count2;
  }
      ...
      <div class="content">
        <div class="women_main">
          ...
          <div class="middle-content">
            ...
            <div>
              <h4>户主：<%=userInfo.getName()%></h4> <td><%=userInfo.getBuilding()%>楼<%=userInfo.getDoor()%>号</td>
              <table class="table">
                <thead>
                <TR>
                  <td></td>
