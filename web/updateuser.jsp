...
<%
  request.setCharacterEncoding("utf-8");
   ...
   if(request.getParameter("id")!=null){
     user=biz.getUserById(request.getParameter("id"));
   }
  if ("chaxun".equals(request.getParameter("update"))) {
     user=biz.getuserByBuildingandDoor(Integer.parseInt(request.getParameter("building")),request.getParameter("door"));
   }
  else if("xiugai".equals(request.getParameter("update"))){
    user=biz.getUserById(request.getParameter("id"));
  user.setName(request.getParameter("name"));
  user.setPhone(request.getParameter("phone"));
  user.setMobilephone(request.getParameter("mobilephone"));
  user.setWorkunit(request.getParameter("workunit"));
  user.setValid(Integer.parseInt(request.getParameter("valid")));
  user.setPermanent(request.getParameter("permanent"));
  biz.save(user);
  //user=null;
  }
%>
      ...
      <div class="content">
        <div class="women_main">
          ...
          <div class="middle-content">
            ...
            <div>
              <form action="updateuser.jsp?update=chaxun" method="post" id="chaxun">
              <tr>
                <td>楼号：</td>
                <td>
              ...
              <form action="updateuser.jsp?update=xiugai" id="xiugai" method="post">
                <input type="hidden" name="id" value="<%=user.getId()%>">
                <div>
                  <label>户主姓名</label>
                  <label>
                    <input name="name" type="text" tabindex="1"  value="<%=user.getName()%>" >
                  </label>
                </div>
                <div>
                  <label>家庭电话</label>
                  <label>
                    <input name="phone" type="text" tabindex="3" required="" value="<%=user.getPhone()%>">
                  </label>
                </div>
                ...
                <div>
                  <label>手机</label>
                  <label>
                    <input name="mobilephone" type="text" tabindex="5" required="" value="<%=user.getMobilephone()%> "  pattern="\w{11}" title="手机号码为11位数字">
                  </label>
                </div>
                <div>
                  <label>工作单位</label>
                  <label>
                    <input name="workunit" type="text" tabindex="4" required="" value="<%=user.getWorkunit()%>">
                  </label>
                </div>
              ...
              <div>
                <label>是否常住：</label>
                <label>
                  <select name="permanent"><option value="Y">Y</option>
              ...
              <div>
                <label>是否有异常情况：</label>
                <label> <select name="valid"><option value="1">否</option>
